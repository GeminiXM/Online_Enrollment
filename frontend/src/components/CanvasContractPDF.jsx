...
export const generatePDFBuffer = async (formData, signatureData, signatureDate, initialedSections, selectedClub, membershipPrice) => {
  ...
  try {
    ...
    pdf.setFont('helvetica', 'normal');
    const agreementUnderstandingText = `I have read and understand this agreement along with the terms and conditions contained on this document and will abide by the rules and regulations of ${getClubName(selectedClub)}. In addition, I understand that the primary member represents all members and accepts all responsibility on the account and that all memberships are non-transferable and non-assignable to another individual. By signing this document or sending this by facsimile, I do intend it to be my legally binding and valid signature on this agreement as if it were an original signature.`;
