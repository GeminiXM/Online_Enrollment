    ...
    <>
      <div className="contract-section">
        ...
        <div className="section-content">
          ...
          <p>I have read and understand this agreement along with the terms and conditions contained on this document and will abide by the rules and regulations of Colorado Athletic Club. In addition, I understand that the primary member represents all members and accepts all responsibility on the account and that all memberships are non-transferable and non-assignable to another individual. By signing this document, submitting an electronic signature through the authorized online web application, or sending this agreement by mail, email, or hand delivery, I intend such action to serve as my legally binding and valid signature on this agreement as if it were an original signature.</p>
        </div>
      </div>
      ...
      <div className="contract-section">
        ...
        <div className="section-content">
          ...
          <p><strong>A. RESIGNATION POLICY: </strong>A month-to-month membership may be cancelled by providing at least one (1) month's written notice. Cancellation shall be effective on the 1st of the month that is at least one (1) month after the date the notice is delivered. Notice can be provided by first class mail (Certified with Return Receipt Recommended), personal delivery of cancelation form at the club (Obtaining a copy from Club Personnel Recommended), or contact with the club to obtain the current, digital form of cancellation. Concurrently with the delivery of written notice, Member must pay the club any amounts due on the account as of the cancellation date and on or before the cancellation date Member must return all membership cards (if applicable). Those who have signed on an Extended Plan agreement are subject to the terms of their agreement and are responsible for the balance of remaining dues. All memberships are non-refundable, non-transferable, non-assignable and non-proprietary.</p>
          <p className="initial-line">
            <strong>INITIAL</strong>
            <InitialBox
    ...
    <>
      <div className="contract-section">
        ...
        <div className="section-content">
          ...
          <p className="acknowledgment">EACH OF THE UNDERSIGNED MEMBERS ACKNOWLEDGES RECEIPT OF THE FOREGOING NOTICE AND COPIES HEREOF:</p>
          <p>I have read and understand this agreement along with the terms and conditions contained on this document and will abide by the rules and regulations of New Mexico Sports & Wellness. In addition, I understand that the primary member represents all members and accepts all responsibility on the account and that all memberships are non-transferable and non-assignable to another individual. By signing this document, submitting an electronic signature through the authorized online web application, or sending this agreement by mail, email, or hand delivery, I intend such action to serve as my legally binding and valid signature on this agreement as if it were an original signature.</p>
        </div>
      </div>
