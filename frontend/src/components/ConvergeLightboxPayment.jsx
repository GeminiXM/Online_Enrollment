...
console.log('ConvergeLightboxPayment - amountBilled being passed to confirmation:', amountBilled);
      ...
      // Hide popup after navigation is initiated
      // The popup will remain visible during the entire enrollment process
      // and only disappear when the user reaches the confirmation page
    } catch (error) {
