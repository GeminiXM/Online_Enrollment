      ...
      <div className="member-info-summary">
        ...
        <div style={{ 
          ...
          <div style={{ 
            ...
            <div className="primary-member-label-container" style={{ 
              display: 'inline-block',
              width: 'auto',
              padding: '10px 20px'
            }}>
          ...
          <div style={{ 
            ...
            <div style={{ flex: '1', maxWidth: '350px' }}>
              <div style={{ marginBottom: '20px' }}>
                <div className="info-label" style={{ textAlign: 'left' }}>First Name</div>
                <div className="info-value" style={{ 
                  ...
                  minHeight: '20px',
                  textAlign: 'left'
                }}>{formData.firstName}</div>
              </div>

              <div style={{ marginBottom: '20px' }}>
                <div className="info-label" style={{ textAlign: 'left' }}>E-mail</div>
                <div className="info-value" style={{ 
                  backgroundColor: 'white',
                  border: '1px solid #e0e0e0',
                  padding: '8px 12px',
              ...
              <div style={{ marginBottom: '20px' }}>
                <div className="info-label" style={{ textAlign: 'left' }}>DOB</div>
                <div className="info-value" style={{ 
                  backgroundColor: 'white',
                  border: '1px solid #e0e0e0',
                  padding: '8px 12px',
              ...
              <div style={{ marginBottom: '20px' }}>
                <div className="info-label" style={{ textAlign: 'left' }}>Home Address</div>
                <div className="info-value" style={{ 
                  backgroundColor: 'white',
                  border: '1px solid #e0e0e0',
                  padding: '8px 12px',
              ...
              <div style={{ marginBottom: '20px' }}>
                <div className="info-label" style={{ textAlign: 'left' }}>City</div>
                <div className="info-value" style={{ 
                  backgroundColor: 'white',
                  border: '1px solid #e0e0e0',
                  padding: '8px 12px',
            ...
            <div style={{ flex: '1', maxWidth: '350px' }}>
              <div style={{ marginBottom: '20px' }}>
                <div className="info-label" style={{ textAlign: 'left' }}>Last Name</div>
                <div className="info-value" style={{ 
                  backgroundColor: 'white',
                  border: '1px solid #e0e0e0',
                  padding: '8px 12px',
              ...
              <div style={{ marginBottom: '20px' }}>
                <div className="info-label" style={{ textAlign: 'left' }}>Phone Number</div>
                <div className="info-value" style={{ 
                  backgroundColor: 'white',
                  border: '1px solid #e0e0e0',
                  padding: '8px 12px',
                  ...
                  minHeight: '20px',
                  textAlign: 'left'
                }}>{formData.mobilePhone || formData.cellPhone || ''}</div>
              </div>

              <div style={{ marginBottom: '20px' }}>
                <div className="info-label" style={{ textAlign: 'left' }}></div>
                <div className="info-value" style={{ 
              ...
              <div style={{ marginBottom: '20px' }}>
                <div className="info-label" style={{ textAlign: 'left' }}>Address 2</div>
                <div className="info-value" style={{ 
                  backgroundColor: 'white',
                  border: '1px solid #e0e0e0',
                  padding: '8px 12px',
                  ...
                  minHeight: '20px',
                  textAlign: 'left'
                }}>{formData.address2 || ''}</div>
              </div>

              <div style={{ marginBottom: '20px' }}>
                <div className="info-label" style={{ textAlign: 'left' }}>State & ZIP Code</div>
                <div style={{ 
                  display: 'grid',
                  ...
                  <div>
                    <div className="info-label" style={{ fontSize: '0.8rem', textAlign: 'left' }}>State</div>
                    <div className="info-value" style={{ 
                      backgroundColor: 'white',
                      border: '1px solid #e0e0e0',
                      padding: '8px 12px',
                  ...
                  <div>
                    <div className="info-label" style={{ fontSize: '0.8rem', textAlign: 'left' }}>ZIP Code</div>
                    <div className="info-value" style={{ 
                      backgroundColor: 'white',
                      border: '1px solid #e0e0e0',
                      padding: '8px 12px',
